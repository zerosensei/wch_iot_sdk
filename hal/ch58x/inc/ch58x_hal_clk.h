...
#ifndef HAL_CH58X_INC_CH58X_HAL_CLK_H
#define HAL_CH58X_INC_CH58X_HAL_CLK_H
...
typedef enum {
    ...
    CLK_SOURCE_PLL_80MHZ        = (CLK_MODE_PLL << SYS_CLK_MODE_POS) | (6U),
...
typedef enum {
    LEVEL_32 = 3,   // consuming 1.2ms, 1000ppm at 32MHz frequency; 1100ppm at 64MHz frequency.
    LEVEL_64,       // consuming 2.2ms, 800ppm at 32MHz frequency; 1000ppm at 64MHz frequency.
    LEVEL_128,      // consuming 4.2ms, 600ppm at 32MHz frequency; 800ppm at 64MHz frequency.
} lsi_cali_level_t;
...
#endif /* HAL_CH58X_INC_CH58X_HAL_CLK_H */