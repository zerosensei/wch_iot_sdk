...
void hal_pwr_wakeup_mode(pwr_wakeup_mode_t mode)
{
    ...
    switch (mode) {
    case PWR_WAKEUP_MODE_EDGE_LONG:
        cfg = RB_WAKE_EV_MODE;
        break;
    case PWR_WAKEUP_MODE_EDGE_SHORT:
        cfg = 0;
        break;
    case PWR_WAKEUP_MODE_LEVEL_LONG:
        cfg = RB_WAKE_DELAY;
        break;
    case PWR_WAKEUP_MODE_LEVEL_SHORT:
        cfg = RB_WAKE_EV_MODE | RB_WAKE_DELAY;
        break;
    default:
        break;
    }
